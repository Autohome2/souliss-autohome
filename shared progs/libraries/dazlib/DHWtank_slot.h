...
#define W1_dhw1pump_slot               		N3_W1_PumpLogic1
...
#define N3_W1_BoilerCall                    41	      // request for boiler input from dhw tank (local on DHW node)
...
#define N3_BoilerTriggerLogic            	42                // gas boiler trigger output
#define N3_SolarSYSrunLOGIC              	43                // solar system running input

#define N3_W1_DHWflowLOGIC                  1                //dhw flow switch input
#define W1_dhwflowswitch_slot          N3_W1_DHWflowLOGIC
...
#define N3_W1_TempSensorLogic7              24              // 1st exch tank flow 
#define N3_W1_TempSensorLogic8              26              // 1st exch tank return
...
int W1_Temp_actual_slot[14] ={0,N3_W1_TempSensorLogic1,N3_W1_TempSensorLogic2,N3_W1_TempSensorLogic3,N3_W1_TempSensorLogic4,
...
int W1_Temp_setval_slot[14] ={0,N3_W1_TempSensorLogic1s,N3_W1_TempSensorLogic2s,N3_W1_TempSensorLogic3s,0,
